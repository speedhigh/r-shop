            ...
            <div class="px-4 py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
              <div class="sm:flex lg:col-span-7">
                <img
                  ...
                  class="aspect-square w-full shrink-0 rounded-lg object-cover sm:size-40"
                />
            ...
            <div class="border-t border-gray-200 px-4 py-6 sm:px-6 lg:p-8">
              ...
              >
                ...
                <div class="mt-6 hidden grid-cols-4 text-sm font-medium text-gray-600 sm:grid">
                  ...
                  <div
                    class="text-center"
                    :class="[product.step > 0 ? 'text-indigo-600' : '']"
                  >
                    Processing
                  </div>
                  <div
                    class="text-center"
                    :class="[product.step > 1 ? 'text-indigo-600' : '']"
                  >
                    Shipped
                  </div>
                  <div
                    class="text-right"
                    :class="[product.step > 2 ? 'text-indigo-600' : '']"
                  >
                    Delivered
                  </div>
                </div>
