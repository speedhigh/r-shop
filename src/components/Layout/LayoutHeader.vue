<template>
  <div class="bg-white relative">
    ...
    <header class="relative overflow-hidden">
      ...
      <nav
        aria-label="Top"
        class="relative z-20 bg-white/90 backdrop-blur-xl backdrop-filter"
      >
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center">
            ...
            <!-- Logo -->
            <div class="ml-4 flex lg:ml-0 lg:mr-2">
              <router-link to="/">
                <h2 class="font-bold">Reading-Shop 👌🏻</h2>
              </router-link>
            </div>
                ...
                >
                  ...
                  >
                    <PopoverPanel class="absolute inset-x-0 top-full bg-white text-sm text-gray-500">
                      ...
                      >
                        <div
                          class="h-px w-full transition-colors duration-200 ease-out"
